            ...
            <div className={'FlexCol ' + styles.InfographicContainer}>
              <div className={'FlexCol ' + styles.InfographicContent}>
                <h1 className='SubHeadText BlackText'>
                  ...
                  <h1 className='SubHeadText BlackText'>
                    This entire project is open-source and is located on <Link href='https://github.com/DrakeB1234/ProjectSocialFunc' target='_blank' className='WhiteText BoldText'>github</Link>. Consider taking a look

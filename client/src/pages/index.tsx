      ...
      <main>
        ...
        <div className={'FlexCol ' + styles.LandingContainer}>
            ...
            <div className={'FlexCol ' + styles.InfographicContainer}>
              ...
              <h1 className='SubHeadText GreyText'>
            ...
            <div className={'FlexCol ' + styles.UpdatesContainer}>
              ...
              <div className={'FlexCol ' + styles.UpdatesContent}>
                <h1 className='SubHeadText GreyText'>Feburary 11, 2023</h1>
            ...
            <div className={'FlexCol ' + styles.InfographicContainer}>
              ...
              <h1 className='SubHeadText GreyText'>
                This entire project is open-source and is located on <Link href='https://github.com/DrakeB1234/ProjectSocialFunc' target='_blank' className='BlackText BoldText'>github</Link>. Consider taking a look
